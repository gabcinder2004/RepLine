...
local function BuildEditFrame()
    ...
    SafeSetFont(editFrame.title, 11)
    ...
    SafeSetFont(editFrame.subtitle, 9)
    editFrame.subtitle:SetTextColor(unpack(C_DETAIL))
    editFrame.subtitle:SetPoint("TOPLEFT", 16, -28)
